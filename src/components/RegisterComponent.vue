  ...
  <v-container class="" fluid>
    ...
    <v-card class="mx-auto pa-12 pb-8" elevation="8" max-width="448" rounded="lg">
      ...
      <v-text-field v-model="password" :append-icon="show1 ? 'mdi-eye' : 'mdi-eye-off'"
        ...
        label="Password" hint="At least 8 characters" counter @click:append="show1 = !show1"></v-text-field>
      ...
      <v-card-text class="text-center">
        <v-btn block class="mb-8 text-blue text-decoration-none" rel="noopener noreferrer" to="/login">
          Already account?
        </v-btn>
      </v-card-text>
